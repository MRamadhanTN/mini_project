...
<div class="col-12 d-flex mb-5">
    ...
    <div class="col-10 d-flex flex-column">
        ...
        <div class="col-10 d-flex flex-column">
            @foreach($data as $dt)
                ...
                <div class="row g-0">
                <a href="{{ route('show.page', $dt->id) }}" class="col-md-4">
                    <img style="width: 220px"src="{{ asset('profile/'.$dt->image) }}" alt="...">
                </a>
                <div class="col-md-8">
                    <div class="card-body">
                        <p>{{ $dt->category->name }}</p>
    ...
    {{-- sticky right --}}
    <div class="col-2 card position-sticky" style="width: 18rem; height: 30rem; top: 40px; right: 40px;">
